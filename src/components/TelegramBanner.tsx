...
export default function TelegramBanner() {
  return (
    <div className="bg-gradient-to-r from-blue-50 to-blue-100 text-blue-800 border border-blue-200 rounded-lg shadow-sm mb-4 overflow-hidden">
      <div className="flex items-center p-2 sm:p-3">
        ...
        <div className="flex-shrink-0 ml-3">
          <a 
            ...
            className="inline-flex items-center bg-blue-600 text-white font-medium text-xs sm:text-sm px-3 py-1 rounded-full hover:bg-blue-700 transition-colors"
          >
            Acessar Canal
          </a>
        </div>
