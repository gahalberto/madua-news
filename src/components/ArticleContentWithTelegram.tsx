...
interface ArticleContentWithTelegramProps {
  content: string; // Conteúdo Markdown ou HTML
}

export default function ArticleContentWithTelegram({ content }: ArticleContentWithTelegramProps) {
  ...
  return (
    <div className="prose prose-lg max-w-none">
      ...
      {/* Banner do Telegram no meio do artigo */}
      <div className="my-8">
        <TelegramBanner />
      </div>
